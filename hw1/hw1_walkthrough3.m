...
% Pad left and right
% I made a modifacation here as width_diff is odd number
...
% Pad top and bottom
%iresized_mask = ???
iresized_mask = [zeros(floor(height_diff/2), size(iresized_mask, 2));...
    iresized_mask; zeros(ceil(height_diff/2), size(iresized_mask, 2))];
